...
public class SuperUser implements Serializable {
    ...
    public void setPostalCode(int postalCode) {
        if (postalCode >= 1000 && postalCode <= 9999) {
            ...
            System.out.println("Invalid postal code. Postal code must be between 1000 and 9999.");
        }
    }
    public void setFullName(@NotNull String fullName) {
        if (fullName.length() >= 5 && fullName.length() <= 50 && fullName.contains(" ")) {
            ...
            System.out.println("Invalid full name. Full name must be between 5 and 50 characters and contain a space.");
        }
    }
